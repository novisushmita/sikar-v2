...
// COMPLETE_ORDER_URL dihapus — sopir tidak punya aksi selesai

let activeOrders = [];
let isKehadiranActive = false;
let sopirData = null;
...
// completeOrder dihapus — konfirmasi selesai dilakukan oleh penumpang atau kepala sopir
    ...
    return `
        <div class="border border-gray-200 rounded-lg md:rounded-xl p-4 md:p-5 transition-all hover:shadow-md">
            ...
            <div class="border-t border-gray-100 pt-3 space-y-2">
                ...
                <!-- ACTION BUTTON -->
                <!-- Sopir hanya bisa mulai perjalanan. Tidak ada tombol selesai. -->
                ${
